export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      thresholds: {
        title: '评分阈值',
        description: '自定义每个内容审计类别的评分阈值，分数达到或超过阈值时视为命中。',
        resetDefault: '恢复默认',
        ...
        selfHarm: '自残',
        selfHarmIntent: '自残意图',
        selfHarmInstructions: '自残指南',
        sexual: '性内容',
        sexualMinors: '涉未成年性内容',
        violence: '暴力',
        violenceGraphic: '血腥暴力',
      },
      keywords: {
        title: '关键词规则',
        description: '配置关键词规则，在内容审计前后对匹配特定模式的请求执行拦截或标记操作。',
        addRule: '添加规则',
        batchImport: '批量导入',
        batchImportPlaceholder: '每行一个关键词，全部以子串匹配拦截规则导入。',
        batchImportConfirm: '确认导入',
        removeRule: '删除',
        patternPlaceholder: '关键词或正则表达式',
        notePlaceholder: '备注（可选）',
        matchTypeSubstring: '子串匹配',
        matchTypeRegex: '正则匹配',
        actionBlock: '拦截',
        actionFlag: '标记',
        ...
        enabled: '启用',
        testTitle: '规则测试',
        testPlaceholder: '输入要测试的文本，验证当前规则是否命中',
        testButton: '测试规则',
        testRunning: '测试中...',
        testBlockHit: '命中拦截规则',
        testFlagHits: '命中标记规则',
